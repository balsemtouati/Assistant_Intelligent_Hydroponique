"""Scraper pour la catégorie 'substrats'

URL de base: https://www.croquepousse.com/substrats/
Fonctionnalités: identiques à scrap_mesures.py
 - JSONL: substrats_data/substrats_articles.jsonl
 - JSON array par défaut: substrats_data/substrats_all.json
...
BASE_URL = "https://www.croquepousse.com/substrats/"
...
def crawl(args):
    ...
    jsonl_path = os.path.join(args.output_dir, 'substrats_articles.jsonl')
    ...
    out_path = os.path.join(args.output_dir, 'substrats_all.json')
...
def build_parser():
    p = argparse.ArgumentParser(description="Scraper substrats (articles détaillés)")
    p.add_argument('--base-url', default=BASE_URL)
    p.add_argument('--max-pages', type=int, default=40)
    p.add_argument('--delay', type=float, default=1.0)
    p.add_argument('--retries', type=int, default=3)
    p.add_argument('--output-dir', default='substrats_data')
